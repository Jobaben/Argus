...
const session: SessionDetail = {
  ...
  messages: [
    { index: 0, type: "message", role: "user", timestamp: "2026-07-06T00:00:00Z", model: null, text: "hi", toolName: null, isError: false },
    { index: 1, type: "message", role: "assistant", timestamp: null, model: "claude-fable-5", text: "hello", toolName: null, isError: false },
    { index: 2, type: "tool_result", role: null, timestamp: null, model: null, text: "boom", toolName: "Bash", isError: true },
  ],
};
